...
#         return True
    ...
    def start(
        ...
        **kwargs,
        ...
        box = LocalPyBox(km=km, mkm=self.kernel_manager)
        self.boxes[kid] = box
        return box
    ...
    def shutdown(
        ...
        *,
        ...
        #     box = self.boxes[kernel_id]
        #     box.shutdown()
        #     del self.boxes[kernel_id]
        # except KeyError:
        #     # logger.warning("kernel %s not found", kernel_id)
        #     print("kernel %s not found", kernel_id)
        # else:
        #     # logger.info("Kernel %s shut down", kernel_id)
        #     print("Kernel %s shut down", kernel_id)
        pass

    # def shutdown_all(self, *args, **kwargs):
    #     if len(self.kernel_manager):
    #         for kernel_id in list(self.boxes.keys()):
    #             box = self.boxes[kernel_id]
    #             box.shutdown()
    #             del self.boxes[kernel_id]
