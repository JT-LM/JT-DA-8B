...
class JiutianModel(nn.Module):
    ...
    def __init__(
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: JiutianDecoderLayer(config=config,
                                             cache_config=cache_config,
                                             quant_config=quant_config),
...
class JiutianForCausalLM(nn.Module, SupportsLoRA):
    ...
    def __init__(
        ...
        self.model = JiutianModel(config, cache_config, quant_config)
